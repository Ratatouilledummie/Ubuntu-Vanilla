...
sudo chroot $HOME/$name/chroot apt install -y vanilla-gnome-desktop vanilla-gnome-default-settings gdm3 gnome-maps gnome-weather polari gnome-documents gnome-photos gnome-music gnome-shell libreoffice
