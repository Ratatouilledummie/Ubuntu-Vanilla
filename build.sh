...
sudo chroot $HOME/$name/chroot apt install -y gnome-shell gnome vanilla-gnome-desktop vanilla-gnome-default-settings gdm3 wayland gnome-maps gnome-weather polari gnome-documents gnome-photos gnome-music gnome-shell libreoffice
